      ...
      <View style={{}}>
        ...
        <View style={RN_SCREEN_Styles.questions_View}>
          <Text style={RN_SCREEN_Styles.questions_text_style}>
            Q{'.)'} Which of the following is the correct plugin to navigate
        ...
        <View style={RN_SCREEN_Styles.options_view}>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                ...
                <Text style={{color: 'black'}}>React Hooks</Text>
              </TouchableOpacity>
            </View>
            {/* option 2nd */}
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>React Navigation</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={{flexDirection: 'row'}}>
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>React Router</Text>
              </TouchableOpacity>
            </View>
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
