      ...
      <View style={{}}>
        ...
        <View style={RN_SCREEN_Styles.questions_View}>
          <Text style={RN_SCREEN_Styles.questions_text_style}>
            Q{'.)'} Which of the following is the correct way to render a
            webpage.
          </Text>
        </View>
        {/* options view */}
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                ...
                <Text style={{color: 'black'}}>React Native webview</Text>
              </TouchableOpacity>
            </View>
            {/* option 2nd */}
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>React Native HTML</Text>
              </TouchableOpacity>
            </View>
          </View>
