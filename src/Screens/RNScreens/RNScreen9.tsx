      ...
      <View style={{}}>
        ...
        <View style={RN_SCREEN_Styles.questions_View}>
          <Text style={RN_SCREEN_Styles.questions_text_style}>
            Q{'.)'} How do we detect platforms in React Native?
          </Text>
        </View>
        {/* options view */}
        <View style={RN_SCREEN_Styles.options_view}>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                ...
                <Text style={{color: 'black'}}>Platform.OS</Text>
              </TouchableOpacity>
            </View>
            {/* option 2nd */}
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>Phone.OS</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={{flexDirection: 'row'}}>
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>Dimension.OS</Text>
              </TouchableOpacity>
            </View>
            <View style={RN_SCREEN_Styles.individual_option_view}>
              <TouchableOpacity
                style={RN_SCREEN_Styles.individual_option_button}>
                <Text style={{color: 'black'}}>RN.OS</Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={RN_SCREEN_Styles.previous_forward_button_view}>
          ...
          <View style={RN_SCREEN_Styles.forward_button_view}>
            <TouchableOpacity
              ...
              onPress={() => Navigation.navigate('Screen 10')}>
