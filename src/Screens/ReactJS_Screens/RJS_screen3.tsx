      ...
      <View
        ...
        <View style={QuizzyStyles.questions_View}>
          <Text style={QuizzyStyles.questions_text_style}>
            {ReactJS_Questions[2].number}.{')'} {ReactJS_Questions[2].question}
          </Text>
        </View>
        {/* options view */}
        <View style={QuizzyStyles.optionsContainer}>
          <View style={QuizzyStyles.options_view}>
            <View style={{flexDirection: 'column'}}>
              {ReactJS_Questions[2].options.map((question, index) => (
            ...
            <View style={{flex: 1}}>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => Navigation.navigate('RJS screen 4')}>
